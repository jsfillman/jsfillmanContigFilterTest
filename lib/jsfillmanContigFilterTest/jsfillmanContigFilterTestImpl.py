...
class jsfillmanContigFilterTest:
    '''
    Module Name:
...
This sample module contains one small method that filters contigs.
    ...
    def run_jsfillmanContigFilterTest(self, ctx, params):
        """
        ...
        #BEGIN run_jsfillmanContigFilterTest

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_jsfillmanContigFilterTest function. Params=' + pformat(params))
        ...
        #END run_jsfillmanContigFilterTest

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_jsfillmanContigFilterTest return value ' +
